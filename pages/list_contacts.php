...
while(($contact = $results->fetch_assoc()) != null) {
	...
	echo "<tr><td>$contact_firstname</td><td>$contact_lastname</td><td><a href=\"mailto:$contact_email\"> $contact_email</a></td><td>$phone</td><td><a href=\"./?p=form_edit_contact&id=$contact_id\" ><button type=\"submit\" class=\"btn btn-warning\"><i class=\"icon-edit icon-white\"></i></button></a></td>";
	echo "<td><form style=\"display:inline;\" method=\"post\" action = \"actions/delete.php\"><button type=\"submit\" class=\"btn btn-danger\"><i class=\"icon-trash icon-white\"></i></button><input type=\"hidden\" name=\"id\" value=\"$contact_id\"/></form></td></tr>";
}
echo '</table>';
